...
//            fatalError("Unresolved error \(nsError), \(nsError.userInfo)")
    ...
    init(inMemory: Bool = false) {
        ...
        if inMemory {
            ...
            container.persistentStoreDescriptions.first!.url = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.com.mahaldiapps.DexGroup")!.appending(path: "Dex.sqlite")
        }
